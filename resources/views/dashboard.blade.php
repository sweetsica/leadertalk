                            ...
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Marketing</p>
                                        <span class="title text-black font-w600">{{$infos['count_mkt']}} Câu hỏi</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card avtivity-card">
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Dịch vụ bán hàng</p>
                                        <span class="title text-black font-w600">{{$infos['count_dvbh']}} Câu hỏi</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card avtivity-card">
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Kế toán</p>
                                        <span class="title text-black font-w600">{{$infos['count_kt']}} Câu hỏi</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card avtivity-card">
                            <div class="card-body">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body">
                                        <p class="fs-14 mb-2">Phòng ban khác</p>
                                        <span class="title text-black font-w600">{{$infos['count_other']}} Câu hỏi</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-header d-sm-flex d-block pb-0 border-0">
                        <div class="mr-auto pr-3 mb-sm-0 mb-3">
                            <h4 class="text-black fs-20">Tổng kết</h4>
                            <p class="fs-13 mb-0 text-black">Số vấn đề</p>
                        </div>
                        <div class="dropdown mb-3 show">
                            <button type="button" disabled class="btn rounded btn-light" data-toggle="dropdown" aria-expanded="true">
