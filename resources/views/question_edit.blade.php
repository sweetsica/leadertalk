                                ...
                                <div id="profile-settings" class="tab-pane fade">
                                    <div class="pt-3">
                                        <div class="settings-form">
                                            ...
                                            <form action="{{route('question.update',$infos->id)}}" method="post">
                                                @csrf
                                                @method('PUT')
                                                <div class="form-row">
                                                    @if(isset($infos->solution))
                                                        {{$infos->answear}}
                                                    @else
                                                        <textarea name="answear" id="textarea" cols="30" rows="5" class="form-control bg-transparent" placeholder="Nhập câu trả lời..."></textarea>
                                                    @endif
                                                </div>
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="form-group mb-0">
                                                            <label class="radio-inline mr-3"><input type="radio" value="Đã xử lý" name="status"> Đã xử lý</label>
                                                            <label class="radio-inline mr-3"><input type="radio" value="Đang chờ xử lý" checked name="status"> Đang chờ</label>
                                                            <label class="radio-inline mr-3"><input type="radio" value="Từ chối" name="status"> Từ chối</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <button type="button submit" style="float:right;" class="btn btn-outline-success">Hoàn tất</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
